        ...
        >
            <div className="flex border border-gray-700 rounded-full">
                ...
                <input
                    ...
                    placeholder="Search..."
                    className="w-full flex justify-start items-center px-3 py-2 focus:outline-none bg-transparent transition-all duration-300 ease-in-out hover:w-[20rem] focus:w-[20rem]"
                />
